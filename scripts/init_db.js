...
const mockTours = [
  {
    ...
    description:
      "Un voyage d'une journée entière, guidé privativement, combinant l'héritage juif et médiéval de Gérone avec les villages côtiers raffinés de la Costa Brava.",
    ...
    highlights: [
      "Quartier Juif (El Call)",
      "Village médiéval de Pals",
      "Calella de Palafrugell & Llafranc",
      "Randonnée Camí de Ronda optionnelle",
  ...
  },
  {
    ...
    description:
      "Une randonnée immersive à faible impact (6km) commençant dans une ville médiévale, avec des chapelles romanes et des vallées forestières. Idéal pour le calme.",
    duration: "Journée entière",
    group_size: "1-8",
    price: 95,
    ...
    highlights: [
      "Départ village médiéval",
      "Chapelles romanes",
      "Vallées forestières",
      "Paysages paisibles",
      "Marche immersive 6km",
    ],
    is_active: true,
  },
  {
    ...
    description:
      "Une expérience guidée en kayak explorant grottes marines, vie marine et falaises escarpées. Opéré avec des partenaires locaux audités.",
  ...
  },
  {
    ...
    description:
      "Une journée combinant le paysage majestueux et la spiritualité de Montserrat avec la visite d'une bodega familiale et une dégustation.",
    duration: "Demi/Journée entière",
    group_size: "1-8",
    price: 125,
  ...
  },
  {
    ...
    description:
      "Une journée complète reliant la profondeur médiévale de la Catalogne au charme côtier du sud de la France.",
    duration: "Journée entière",
    group_size: "1-8",
    price: 165,
    ...
    highlights: [
      "Cathédrale de Gérone & El Call",
      "Traversée des Pyrénées",
      "Port & Forteresse de Collioure",
      "Dégustation d'anchois boutique",
      "Déjeuner méditerranéen complet",
    ],
    is_active: true,
  },
  {
    ...
    description:
      "Une exploration slow-travel des quartiers Gothique et Born, dévoilant l'histoire, les légendes et les histoires de quartier loin des circuits bondés.",
    ...
    highlights: [
      "Quartiers Gothique & Born",
      "Histoire cachée",
      "Légendes & récits locaux",
      "Loin des foules",
    ],
    is_active: true,
  },
  {
    ...
    description:
      "Une randonnée côtière spectaculaire (6km) sur l'un des sentiers les plus emblématiques de Catalogne. Forêts de pins et criques turquoises.",
    duration: "Journée entière",
    group_size: "1-8",
    price: 85,
...
async function init() {
  ...
  if (configError) {
    ...
    console.log(
      "(Note: This probably means the table site_config does not exist yet)",
    );
  } else {
  ...
  for (const tour of mockTours) {
    const { error: defaultTourError } = await supabase
      .from("default_tours")
      .upsert(tour);
    if (defaultTourError) {
      console.error(
        `Error syncing default tour ${tour.id}:`,
        defaultTourError.message,
      );
    } else {
