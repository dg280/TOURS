...
export const translations = {
    fr: {
        ...
        contact: {
            ...
            validation_error: 'Merci de remplir les champs nom, email et message.',
            server_error: 'Erreur serveur',
            success_message: 'Message envoyé ! Nous vous répondrons rapidement.',
            send_error: "Impossible d'envoyer le message. Réessayez ou contactez-nous par WhatsApp.",
        ...
        booking: {
            ...
            spots_remaining_one: 'place restante',
            spots_remaining_other: 'places restantes',
            available: 'Disponible',
            filling_up: 'Presque plein',
            full: 'Complet',
            closed: 'Fermé',
            server_error: 'Erreur serveur',
            missing_client_secret: 'Client secret manquant dans la réponse',
            loading_error: 'Erreur de chargement',
            date_unavailable: 'Cette date est indisponible. Veuillez en choisir une autre.',
            date_full: 'Cette date est complète. Veuillez en choisir une autre.',
            departure_time: 'Heure de départ',
            estimated_duration: 'Durée estimée',
            name_placeholder: 'Jean Dupont',
            phone_placeholder: '+33 6 ...',
            address_placeholder: 'Hôtel / Adresse exacte',
            optional: '(Optionnel)',
            date_colon: 'Date :',
            ...
            error_label: 'Erreur :',
            invalid_key_message: 'est incorrecte. Elle doit commencer par \'pk_test_\' ou \'pk_live_\'.',
            back_to_settings: 'Retour aux réglages',
            initializing_payment: 'Initialisation du paiement...',
            thank_you_message: 'Merci {name}. Un email de confirmation a été envoyé à {email}.',
            date_and_time: 'Date & Heure',
            client_label: 'Client',
            approx: '(Approx)',
            est_duration: 'Durée estimée :',
            pickup_time_short: 'Heure pick-up',
            duration_short: 'Durée',
            confirmation_email_error: 'Erreur email de confirmation',
            confirmation_email_failed: "Impossible d'envoyer l'email de confirmation.",
            mode_test: 'Mode Test',
            mode_live: 'Mode Live',
            public_key_label: 'La clé publique'
        },
        tour_dialog: {
        ...
        checkout: {
            loading_form: 'Chargement du formulaire sécurisé...',
    ...
    en: {
        ...
        contact: {
            ...
            validation_error: 'Please fill in the name, email and message fields.',
            server_error: 'Server error',
            success_message: 'Message sent! We will get back to you shortly.',
            send_error: 'Unable to send your message. Please try again or contact us via WhatsApp.',
        ...
        booking: {
            ...
            spots_remaining_one: 'spot left',
            spots_remaining_other: 'spots left',
            available: 'Available',
            ...
            date_unavailable: 'This date is unavailable. Please select another date.',
            date_full: 'This date is fully booked. Please select another date.',
            departure_time: 'Departure time',
            estimated_duration: 'Estimated duration',
            name_placeholder: 'John Doe',
            phone_placeholder: '+1 555 ...',
            address_placeholder: 'Hotel / Exact address',
            optional: '(Optional)',
            date_colon: 'Date:',
            ...
            error_label: 'Error:',
            invalid_key_message: 'is incorrect. It must start with \'pk_test_\' or \'pk_live_\'.',
            back_to_settings: 'Back to settings',
            initializing_payment: 'Initializing payment...',
            thank_you_message: 'Thank you {name}. A confirmation email has been sent to {email}.',
            date_and_time: 'Date & Time',
            client_label: 'Client',
            approx: '(Approx)',
            est_duration: 'Est. duration:',
            pickup_time_short: 'Pickup time',
            duration_short: 'Duration',
            confirmation_email_error: 'Confirmation email error',
            confirmation_email_failed: 'Failed to send confirmation email.',
            mode_test: 'Test Mode',
            mode_live: 'Live Mode',
            public_key_label: 'The public key'
        },
        tour_dialog: {
        ...
        checkout: {
            loading_form: 'Loading secure payment form...',
    ...
    es: {
        ...
        tours: {
            ...
            section_title: 'Excursiones Guiadas en Cataluña',
        ...
        contact: {
            ...
            validation_error: 'Por favor, rellena los campos nombre, email y mensaje.',
            server_error: 'Error del servidor',
            success_message: '¡Mensaje enviado! Te responderemos pronto.',
            send_error: 'No se pudo enviar el mensaje. Inténtalo de nuevo o contáctanos por WhatsApp.',
        ...
        booking: {
            ...
            spots_remaining_one: 'plaza restante',
            spots_remaining_other: 'plazas restantes',
            available: 'Disponible',
            filling_up: 'Casi lleno',
            full: 'Completo',
            closed: 'Cerrado',
            server_error: 'Error del servidor',
            missing_client_secret: 'Falta el client secret en la respuesta',
            loading_error: 'Error de carga',
            date_unavailable: 'Esta fecha no está disponible. Por favor elige otra fecha.',
            date_full: 'Esta fecha está completa. Por favor elige otra fecha.',
            departure_time: 'Hora de salida',
            estimated_duration: 'Duración estimada',
            name_placeholder: 'Juan García',
            phone_placeholder: '+34 6 ...',
            address_placeholder: 'Hotel / Dirección exacta',
            optional: '(Opcional)',
            date_colon: 'Fecha:',
            ...
            error_label: 'Error:',
            invalid_key_message: 'es incorrecta. Debe empezar por \'pk_test_\' o \'pk_live_\'.',
            back_to_settings: 'Volver a los ajustes',
            initializing_payment: 'Inicializando el pago...',
            thank_you_message: 'Gracias {name}. Se ha enviado un email de confirmación a {email}.',
            date_and_time: 'Fecha y Hora',
            client_label: 'Cliente',
            approx: '(Aprox)',
            est_duration: 'Duración est.:',
            pickup_time_short: 'Hora recogida',
            duration_short: 'Duración',
            confirmation_email_error: 'Error email de confirmación',
            confirmation_email_failed: 'No se pudo enviar el email de confirmación.',
            mode_test: 'Modo Test',
            mode_live: 'Modo Live',
            public_key_label: 'La clave pública'
        },
        tour_dialog: {
        ...
        checkout: {
            loading_form: 'Cargando formulario de pago seguro...',
