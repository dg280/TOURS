...
- **Target keywords**:
  - _Primary_: "Authentic Barcelona tours", "Private guide Catalonia", "Hidden gems Barcelona".
  - _Additional_: "Private Montserrat tour", "Costa Brava day trip from Barcelona".
